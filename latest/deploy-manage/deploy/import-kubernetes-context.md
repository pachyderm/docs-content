...
After you have deployed {{%productName%}} with [Helm](../helm-install/), the {{%productName%}} context is not created. Therefore, **you need to manually create a new {{%productName%}} context with
