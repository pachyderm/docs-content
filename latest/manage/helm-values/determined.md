...
description: Connect to Determined for a combined auth experience.
date: 
# taxonomy #
tags: ["helm"]
series: ["helm"]
...
Determined AI is a platform designed to help data scientists and machine-learning engineers train deep learning models at scale.
