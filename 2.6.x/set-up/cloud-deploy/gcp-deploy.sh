...
# randomly generate a project id and project name that both start with "pach-"

# PROJECT_ID="pach-$(cat /dev/urandom | tr -dc 'a-z0-9' | fold -w 6 | head -n 1)"



# PLEASE CHANGE THESE NEXT 3 VARIABLES AT A MINIMUM
PROJECT_ID="pach-002"
PROJECT_NAME="ELBY-PACH-002"
NAME="fuzzy-cat-milo"
